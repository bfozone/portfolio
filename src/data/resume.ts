...
export const skills: Record<string, string> = {
  ...
  "ML & LLMs": `RAG over a vector database for markdown and LaTeX docs, MCP for datalake retrieval, agent loops for what used to be desk research. In daily use for risk work. The pitch deck says AI, the code says LLM. Most of the work is knowing where the model shouldn't be trusted. Hallucination is the base rate, not the tail.`,
};
